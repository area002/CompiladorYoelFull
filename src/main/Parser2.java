...
public class Parser2 {
	...
	private void error(int t,String to){
		...
		case Token.LOP:
			//if(to.equals("arit"))
				output +="Error Sintactico, linea: "+tk.getLine()+" se esperaba un operador logico\n";
			break;
		case Token.AOP:
			output +="Error Sintactico, linea: "+tk.getLine()+" token \""+tk.getToken()+"\" no es un operador artimetico \n";
			break;
		case Token.Type:
		...
		case Token.ID:
			...
			break;
		case Token.ID_DIG:
			output +="Error Sintactico, linea: "+tk.getLine()+" token \""+tk.getToken()+"\" no es un identificador o digito";
			break;
		case noValue:
			output +="Error Sintactico, linea: "+tk.getLine()+" se esperba un Digiti, Boolean o String";
			break;
		case exceso:
			output +="Error Sintactico, linea: "+tk.getLine()+" \""+tk.getToken()+"\" la gramatica no es compatible\n";
			break;
		default:
